...
echo "12 assemble      - build per-TF records from the projected tables"
#   python 12_assemble/build_tf_records.py
...
echo "11 variants      - 11_variants: fetch -> build_variant_db.py -> project_variants_to_tfs.py"

echo "12 assemble      - apply curation overlays, then build aggregates"
#   python 12_assemble/overlays/recuration_apply.py
#   python 12_assemble/build_api_index.py
#   python 12_assemble/compute_constraint_stats.py
#   python 12_assemble/build_downloads.py
